...
{'my_number': 89, 'name': 'My F'dict'> -> <class 'BaseModel'>
...
Update your command interpreter (console.py) to have these commands:
    ...
    create: Creates a new instance of BaseModel, saves it (to the JSON file) and prints the id.** (ex: $ destroy)
...
(hbnb) 
(hbnb) User.show("38f2 MEMBERS
Adams Adjartey, Sasha-Lee Olivier irst Model', '__class__': 'BaseModel', 'updated_at': '2017-09-28T21:05:54.119572', 'id': 'b6a6e15c-c67d-4312-9a75-9d084935e579', 'created_at': '2017-09-28T21:05:54.119427'}
JSON of my_model:
    my_number: (<class 'int'>) - 89
...
<class 'BaseModel'> -> to_dict() -> <class  Ex: $ create BaseModel
    ...
    destroy: Deletes an instance based on the class name and id (save the change into the JSON file). Ex: $ destroy BaseModel 1234-1234-1234.
        If the class name is missing, print ** class name missing 9, 28, 21, 11, 14, 963058), 'id': '9bf17966-b092-4996-bd33-26a5353cccb4', 'created_at': datetime.datetime(2017, 9, 28, 21, 11, 14, 963049)}
...
[User] (d0ef8146-42813-2753-4d42-b37c-57a17f1e4f88")
...
PROJECT MEMBERS 
Adams Adjartey, Sasha-Lee Olivier 
